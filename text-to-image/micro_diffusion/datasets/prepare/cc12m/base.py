...
# this is to avoid PIL errors when loading images
    ...
    def __getitem__(self, index):
        ...
        for i, tr in enumerate(self.transforms_list):
            ...
            try:
                ...
                ret[f'image_{i}'] = torch.zeros(3, 256, 256)
                print(f'Error processing image {i}: {e}. If this happens often, your dataset might be corrupted.')
