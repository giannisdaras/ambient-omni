...
slurmify submit-parametric-array \
  ...
  --parameter "dataset_path:/scratch/07362/gdaras/datasets/afhqv2-64x64-partitioned/0/" \
  --parameter "annotated_dataset_path:/scratch/07362/gdaras/datasets/afhq-cats-helps-wildlife/" \
