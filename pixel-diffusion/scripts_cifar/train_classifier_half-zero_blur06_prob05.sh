...
#!/bin/bash
PYTHONPATH=.
outdir=/data/vision/torralba/selfmanaged/torralba/scratch/adrianr/ambient/ambient-syn-runs/cifar/aaa-test_classifier_half-zero_blur06_prob05
dataset_path=/data/vision/torralba/selfmanaged/torralba/projects/adrianr/ambient/data_softlink/cifar10/train
precond=edmcls-half-zero
